...
// generated by spritegen from CRATE_SPEC; compiled + golden-tested.
// not yet routed through draw_object (would touch the kind manifest).
#[allow(unused_imports)]
pub(super) use gen_crate::draw_gen_chair;
